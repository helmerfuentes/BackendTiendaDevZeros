   ...
   public static class ProductoInicializador
    {
        public static void InicializadorProducto(MyContext ctx)
        {
            ...
            productos.Add(new Producto { Id = 2, Nombre = "Tomate", CategoriaId=2,Iva=18,Codigo="33333TR",Precio=2000, PorcentajeUtilidad = 2, PorcentajeMaxDescuento = 1, CantidadDisponible = 0 });
